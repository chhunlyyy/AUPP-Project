    ...
    <div class="w-full lg:w-[450]">
      <div class="bg-gray-100 rounded p-3">
        ...
        <div class="mt-3">
          ...
          <small class="">Does the student not exist? <span class="font-medium text-blue-500 cursor-pointer" @click="toast.add({ severity: 'info', summary: 'Available soon!', life: 3000 })">Create New</span></small> 
        </div>

        <div class="mt-3">
          <label for="name">Choose Class</label>
          <Dropdown v-model="enrollForm.class" :options="classList" optionLabel="name" class="mt-1 w-full md:w-14rem"></Dropdown>
        </div>
      ...
      <div class="card">
        ...
        >
          ...
          <template #groupfooter="slotProps">
            <div class="flex justify-content-end font-bold w-full">Total class: {{ groupClass(slotProps.data.user_id) }}</div>
          </template>
        </DataTable>
      </div>
    </div>
